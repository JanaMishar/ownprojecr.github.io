...
<head>
  ...
  <!-- <link href="./css/font-awesome.css" rel="stylesheet"> -->
   <!--  <link href="./css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="../../stock/html/css/style.css" rel="stylesheet">
    <link href="../../stock/html/css/style.css" rel="stylesheet"> -->
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                    ...
                    <div class="dropdown profile-element">
                       <!--  <img alt="image" class="rounded-circle" src="img/profile_small.jpg"/> -->
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="block m-t-xs font-bold"><?php echo 'welcome mr . ' . $_SESSION['name']; ?></span>
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        <li class="active"><a href="<?=addstock ?>">Add Stock</a></li>
        ...
        ?>
                ...
                <tr id="tr_<?php echo $result['id']; ?>">
                    ...
                    <td>
                        <a href="../../stock/html/edit.php?idu=<?php echo $result['id']; ?>" class='btn btn-danger'>Update</a>
        ...
        <script src="<?=javascript.'admindelete.js' ?>"></script>
